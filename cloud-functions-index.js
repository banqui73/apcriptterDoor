...
exports.requestTrial = functions.https.onCall(async (data, context) => {
  ...
  // Validar dominio Gmail/Outlook/etc
        ...
        <body>
          <div class="container">
            ...
            <p style="color: #8fa3bf; line-height: 1.6; margin: 0 0 20px;">
              ...
              1. Abre <a href="https://banqui73.github.io/apcriptterDoor/">AegisPattern</a><br>
              2. Ve a <strong>Planes → Activar licencia</strong><br>
              3. Pega: <code style="background: #111929; padding: 2px 6px; color: #f59e0b;">${trialCode}</code><br>
              4. ¡Acceso Premium desbloqueado! 🚀
            </p>

            <div style="background: #111929; border-left: 3px solid #10b981; padding: 15px; margin: 20px 0; border-radius: 4px;">
              <p style="margin: 0; color: #34d399; font-weight: 600;">✅ Con Premium accedes a:</p>
            ...
            <div class="footer">
              <p style="margin: 0;">© 2026 AegisPattern · Cifrado en el navegador · E2E</p>
            </div>
          </div>
        </body>
        </html>
